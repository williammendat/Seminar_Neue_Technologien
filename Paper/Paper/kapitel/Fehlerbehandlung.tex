\section{Fehlerbehandlungen}\label{sec:fehlerbehandlung}
...
erstellt werden müssen, was wie im Kapitel \emph{\nameref{sec:speicherman}} gezeigt, schon sehr teuer ist, und
...
\emph{\nameref{subsec:exceptions}} erwähnt auch nennenswerte Vorteile gegenüber einfachen Status Codes. Deswegen
